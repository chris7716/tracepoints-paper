...
section "Artifacts"
{
  ...
  echo "| cigzip-datasets/${name}.tp.mc${mc}.paf | $(filesize "cigzip-datasets/${name}.tp.mc${mc}.paf") |"
  echo "| cigzip-datasets/${name}.tp.mc${mc}.decompressed.paf | $(filesize "cigzip-datasets/${name}.tp.mc${mc}.decompressed.paf") |"
} >> "$REPORT"
