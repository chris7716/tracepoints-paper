...
- Timestamp: `2026-01-15T11:20:39-06:00`
...
**Command**:
```bash
../WFA2-lib/bin/generate_dataset1 -n 10000 -l 10000 -e 0.1 -o data/simulated/wf-dataset/sample.dataset.21006.seq --unbalanced-indels ^1/ { 
...
/^</ { 
    ...
    print substr($0, 2)
    counter++
}' data/simulated/wf-dataset/sample.dataset.21006.seq > data/simulated/wf-dataset/dataset.21006.fa
```
**Output**:
```text
